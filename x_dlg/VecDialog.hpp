class D_VecDialog {
	idd = -1;
	movingEnable = 1;
	onLoad = "uiNamespace setVariable ['D_VecDialog', _this select 0];[_this select 0] call bis_fnc_guiEffectTiles;call d_fnc_initvecdialog;d_vec_dialog_open = true;d_do_ma_update_n = true";
	onUnLoad = "uiNamespace setVariable ['D_VecDialog', nil];d_vec_dialog_open = false;d_do_ma_update_n = false";
	...
	class controls {
		...
		class DropAmmoButton: RscButtonBase2 {
			idc = 44448;
