...
class D_DomLabel {
	...
	onUnLoad = "uiNamespace setVariable ['D_DomLabel', nil]";
	class controls {
...
class d_DomThree {
	...
	onUnLoad = "uiNamespace setVariable ['d_DomThree', nil]";
	class controls {
...
class d_vehicle_hud {
	...
	duration = 1e+011;
	name="d_vehicle_hud";
	onLoad = "uiNamespace setVariable ['d_vehicle_hud', _this select 0]";
	onUnLoad = "uiNamespace setVariable ['d_vehicle_hud', nil]";
	class controls {
...
class d_FatiguePbar {
	...
	name = "d_FatiguePbar";
	sizeEx = 256;
	onLoad = "uiNamespace setVariable ['d_FatiguePbar', _this select 0]";
	onUnLoad = "uiNamespace setVariable ['d_FatiguePbar', nil]";
	class controls {
		class Bar: RscProgress {
			...
			w = 0.15;
			h = 0.02;
			texture = "#(argb,8,8,3)color(1,1,1,0.6)";
		...
		class txt: RscText {
			...
			shadow = 0;
			colorText[] = {1,1,1,0.6};
			text = "$STR_DOM_MISSIONSTRING_1531";
		};
	};
};