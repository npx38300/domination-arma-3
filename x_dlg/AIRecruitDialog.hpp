class D_AIRecruitDialog {
	idd = -1;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['D_AIRecruitDialog', _this select 0];[_this select 0] call bis_fnc_guiEffectTiles;call d_fnc_fillRecruit;d_airecruit_dialog_open = true;d_do_ma_update_n = true";
	onUnLoad = "uiNamespace setVariable ['D_AIRecruitDialog', nil];d_airecruit_dialog_open = false;d_do_ma_update_n = false";
	...
	class controls {
		...
		class RecruitButton: RscButtonBase2 {
			idc = 1010;
		...
		class DismissAllButton: RscButtonBase2 {
			idc = 1012;
