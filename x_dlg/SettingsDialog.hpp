class D_SettingsDialog {
	idd = -1;
	movingEnable = 1;
	onLoad = "uiNamespace setVariable ['D_SettingsDialog', _this select 0];[_this select 0] call bis_fnc_guiEffectTiles;d_settings_dialog_open = true;d_do_ma_update_n = true";
	onUnLoad = "uiNamespace setVariable ['D_SettingsDialog', nil];d_settings_dialog_open = false;d_do_ma_update_n = false";
