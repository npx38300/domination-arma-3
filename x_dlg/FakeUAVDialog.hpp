class D_FakeUAVDialog {
	idd = -1;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['D_FakeUAVDialog', _this select 0];d_do_ma_update_n = true";
	onUnLoad = "uiNamespace setVariable ['D_FakeUAVDialog', nil];d_do_ma_update_n = false";
