class d_TeleportDialog {
	idd = -1;
	movingEnable = false;
	onLoad="uiNamespace setVariable ['d_TeleportDialog', _this select 0];d_teleport_dialog_open = true;d_do_ma_update_n = true;[_this select 0, 0] call d_fnc_teleportdialoginit";
	onUnLoad="uiNamespace setVariable ['d_TeleportDialog', nil];d_teleport_dialog_open = false;d_do_ma_update_n = false";
