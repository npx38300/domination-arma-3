class D_ArtilleryDialog2 {
	idd = -1;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['D_ArtilleryDialog2', _this select 0];[_this select 0] call bis_fnc_guiEffectTiles;call d_fnc_initArtyDlg2;d_arti_dialog_open = true;d_do_ma_update_n = true";
	onUnLoad = "uiNamespace setVariable ['D_ArtilleryDialog2', nil];d_arti_dialog_open = false;d_do_ma_update_n = false;d_cur_art_marker_ar = nil";
	...
	class controls {
		...
		class RefreshTargetsButton: RscButtonBase2 {
			idc = 1010;
		...
		class ArtyFireButton: RscButtonBase2 {
			idc = 1002;
