class D_MarkArtilleryDialog {
	idd = -1;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['D_MarkArtilleryDialog', _this select 0];[_this select 0] call bis_fnc_guiEffectTiles;call d_fnc_initMarkArtyDlg;d_markarti_dialog_open = true;d_do_ma_update_n = true";
	onUnLoad = "uiNamespace setVariable ['D_MarkArtilleryDialog', nil];d_markarti_dialog_open = false;d_do_ma_update_n = false";
	...
	class controls {
		...
		class ArtyRequestButton: RscButtonBase2 {
			idc = 890;
